...
set(TEXTURE_SOURCE_DIRECTORY "resource/texture")
file(
  GLOB_RECURSE RESOURCE_SOURCE_FILES
  "${CMAKE_CURRENT_SOURCE_DIR}/${SHADER_SOURCE_DIRECTORY}/*.vert"
  "${CMAKE_CURRENT_SOURCE_DIR}/${SHADER_SOURCE_DIRECTORY}/*.frag"
  "${CMAKE_CURRENT_SOURCE_DIR}/${TEXTURE_SOURCE_DIRECTORY}/*.png"
)
...
add_custom_command(
  ...
  COMMAND
    "CSResource" compile ${RESOURCE_SOURCE_FILES} ${SHADER_COMPILED_DIRECTORY} ${PROGRAM_INCLUDE_DIRECTORY}
    ${PROGRAM_SOURCE_DIRECTORY}
  WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
  DEPENDS ${RESOURCE_SOURCE_FILES}
)
