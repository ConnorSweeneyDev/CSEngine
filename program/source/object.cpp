...
namespace cse::base
{
  ...
  void object::initialize(SDL_Window *instance, SDL_GPUDevice *gpu)
  {
    ...
    if (backend_formats & SDL_GPU_SHADERFORMAT_SPIRV)
      ...
      throw utility::sdl_exception("Could not find supported shader format for object");
    ...
    if (!vertex_shader) throw utility::sdl_exception("Could not create vertex shader for object");
    ...
    if (!fragment_shader) throw utility::sdl_exception("Could not create fragment shader for object");
    ...
    if (!graphics.pipeline) throw utility::sdl_exception("Could not create graphics pipeline for object");
    ...
    if (!graphics.vertex_buffer) throw utility::sdl_exception("Could not create vertex buffer for object");
    ...
    if (!graphics.index_buffer) throw utility::sdl_exception("Could not create index buffer for object");
    ...
    if (!transfer_buffer) throw utility::sdl_exception("Could not create transfer buffer for object");
    auto vertex_data =
      reinterpret_cast<graphics::position_color_vertex *>(SDL_MapGPUTransferBuffer(gpu, transfer_buffer, false));
    if (!vertex_data) throw utility::sdl_exception("Could not map vertex data for object");
    ...
    if (!index_data) throw utility::sdl_exception("Could not map index data for object");
    ...
    if (!command_buffer) throw utility::sdl_exception("Could not acquire GPU command buffer for object");
    SDL_GPUCopyPass *copy_pass = SDL_BeginGPUCopyPass(command_buffer);
    if (!copy_pass) throw utility::sdl_exception("Could not begin GPU copy pass for object");
