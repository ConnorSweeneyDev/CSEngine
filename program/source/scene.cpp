...
namespace cse::base
{
  scene::scene(const std::shared_ptr<base::camera> &custom_camera) : camera(custom_camera)
  {
  ...
  void scene::add_object(const std::string &name, const std::shared_ptr<object> &custom_object)
  {
