...
int try_main(int argc, char *argv[])
{
  ...
  {
    auto window = std::make_unique<cse::base::window>("CSE Example", 1280, 720, false, true);
    auto game = std::make_unique<cse::base::game>(std::move(window));
    auto camera = std::make_unique<cse::base::camera>(glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, 0.0f, -1.0f),
                                                      glm::vec3(0.0f, 1.0f, 0.0f), 45.0f, 0.01f, 10.0f);
    auto scene = std::make_unique<cse::base::scene>(std::move(camera));
    auto quad = std::make_unique<cse::base::object>(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f),
